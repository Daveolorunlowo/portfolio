...
const Projects = () => {
    const projects = [
        ...
        {
            title: 'KSOME Production',
            desc: 'A premium Nigerian snack production and delivery platform, featuring a professional storefront and investment community portal.',
            tags: ['React', 'E-commerce', 'Vercel', 'Tailwind'],
            link: 'https://ksomeproduction.vercel.app',
            github: 'https://github.com/Daveolorunlowo/Ksome',
            icon: FaBuilding,
            color: '#10B981',
        },
    ];
